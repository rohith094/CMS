...
// const Singlestudent = () => {
//   return (
//     <div className="relative flex bg-clip-border rounded-xl bg-white text-gray-700  w-full max-w-[48rem] flex-row">
//       <div
...
//           alt="card-image" className="object-cover" />
//       </div>
//       <div className="p-6">
//         <ul style={{width : '450px'}} className=" text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
//           <li className="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600 font-bold">Jntuno : </li>
//           <li className="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600 font-bold">Email : </li>
//           <li className="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600 font-bold">Password : </li>
//           <li className="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600 font-bold">Fname : </li>
//           <li className="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600 font-bold">Lname : </li>
//           <li className="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600 font-bold">Branch : </li>
//           <li className="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600 font-bold">Joiningyear : </li>
//           <li className="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600 font-bold">Currentyear : </li>
//         </ul>
//       </div>
//     </div>
//   )
